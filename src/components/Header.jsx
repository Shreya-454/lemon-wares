...
const Herosec = () => {
            ...
            <div className="flex lg:justify-start justify-center ">
                <p className="text-[#808080] lg:pt-8 md:pt-6 lg:text-start text-center sm:pt-3 pt-2 max-w-[448px] font-inter text-sm sm:text-base font-normal leading-[175%] tracking-[0.8px]">
                  ...
                  sizes backed by 24x7x365 Support.
                      ...
                      <button className="relative sm:pb-3 sm:pt-2 pb-2 pt-1 sm:px-[18px] px-2.5 group rounded-[8px] overflow-hidden  bg-[#B00000] text-white shadow-[0px_0px_64px_0px_#B000004D] hover:shadow-black hover:shadow-2xl
 transition-all before:absolute before:left-0 before:right-0 before:top-0 before:h-0 before:w-full before:bg-black before:duration-500 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0 after:-full after:bg-black after:duration-500 hover:text-white hover:before:h-2/4 hover:after:h-2/4">
          <span className="relative z-10  text-white font-poppins group-hover:text-white duration-500    sm:text-sm text-xs font-normal leading-[171.429%]">Create an Account</span>
        </button>

                          <button className="relative sm:pb-3 sm:pt-2 pb-2 pt-1 sm:px-[18px] px-2.5 group rounded-[8px] overflow-hidden border border-black bg-white text-black shadow-2xl transition-all before:absolute before:left-0 before:right-0 before:top-0 before:h-0 before:w-full before:bg-black before:duration-500 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0 after:-full after:bg-black after:duration-500 hover:text-white hover:shadow-black hover:before:h-2/4 hover:after:h-2/4">
          <span className="relative z-10  text-black font-poppins group-hover:text-white duration-500    sm:text-sm text-xs font-normal leading-[171.429%]">Choose your plan</span>
        </button>
                      </div>
          </div>
