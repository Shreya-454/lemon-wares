  ...
  return (
    <div className="md:pt-[79px] ">
     ...
     data-aos-duration="1000">
          ...
          <div className="lg:w-1/2 w-full px-3">
            <div className="flex flex-wrap flex-row -mx-3">
              <div className="sm:w-1/3 w-1/2 pt-[25px] pb-[9px] lg:mb-[50px] px-3 flex justify-center lg:block items-center" data-aos="fade-up"   data-aos-easing="linear"
     data-aos-duration="1000">
                <img src={cpanel} alt="img1" />
              </div>
              <div className="sm:w-1/3 w-1/2 pt-[22px] px-3 lg:px-0 flex justify-center lg:block items-center" data-aos="fade-up"   data-aos-easing="linear"
     data-aos-duration="1000">
                <img src={imunify} alt="img1" />
              </div>
              <div className="sm:w-1/3 w-1/2 pt-[18px] px-3 lg:px-0 flex justify-center lg:block items-center" data-aos="fade-up"   data-aos-easing="linear"
     data-aos-duration="1000">
                <img src={litespeed} alt="img1" />
              </div>
              <div className="sm:w-1/3 w-1/2 py-5 px-3 lg:px-0 flex justify-center lg:block items-center" data-aos="fade-down"   data-aos-easing="linear"
     data-aos-duration="1000">
     ...
     data-aos-duration="1000">
              ...
              <div className="sm:w-1/3 w-1/2 py-2 px-3 lg:px-0 flex justify-center lg:block items-center" data-aos="fade-down"   data-aos-easing="linear"
     data-aos-duration="1000">
